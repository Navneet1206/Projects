...
General-purpose resume for Linux Support / Admin / DevOps roles.
...
def build_resume():
    ...
    styled_run(
        ...
        "Scripting, Ansible automation, Docker containerization, CI/CD pipelines using GitHub Actions, "
        "system monitoring, log analysis, and Root Cause Analysis (RCA). Experienced in server hardening, "
        "incident resolution, backup and recovery, and maintaining operational documentation. Seeking "
    ...
    skills_data = [
        ...
        ("Linux Administration",
         ...
         "(systemd), SSH Hardening, Firewall (firewalld, UFW), auditd, Log Analysis"),
        ("Technical Support",
         "Troubleshooting, Incident Resolution, Root Cause Analysis (RCA), Log Analysis, "
         "Production & Infrastructure Support"),
        ("Automation & IaC",
         "Bash Shell Scripting, Ansible (Playbooks, Roles, Handlers)"),
        ("Containers & Virtualization",
         "Docker (Build, Compose, Deployment), KVM"),
        ("CI/CD & Version Control",
         "GitHub Actions (Pipeline Build & Maintenance), Git, GitHub"),
        ("Backup & Recovery",
         "Backup Operations, Data Restoration, Recovery Planning"),
        ("Networking",
         "TCP/IP, DNS, DHCP, SSH, HTTP/HTTPS"),
    ]
    ...
    bullets_exp = [
        ...
        "Implement server hardening: SSH key-based authentication, firewall rules "
    ...
    styled_run(p_p1, "Linux Server Hardening with Ansible",
